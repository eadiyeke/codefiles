function [performancematAVG,performancematCAT]=performeval3ext(forest,ntree,x,testsamples,y,ytrains,settest,slct,y_eval,x_eval,cattrg)%ytrains=ytrainset{1,j}
...
[averages, categories]=multipletest2ext(forest,ntree,x,testset,y,slct,x_eval,y_eval,cattrg);%%predictions of our mob forest
%build realizations
